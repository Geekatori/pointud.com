        ...
        feedback: function (data) {
            if (!data.success) {
                ...
                var success = this.template(
                    '<div class="container alert alert-success">{report} <p><a href="#" title="Retour" class="btn btn-link" id="hide-form">Retour</a></p></div>', {
                    report: data.message
                });
                ...
                okFrm.addEventListener('click', function(e){
                    e.preventDefault();
                    document.body.classList.remove('visible-contact');
                });
            }
        },
        fail: function (data) {
